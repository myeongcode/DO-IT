    ...
    >
      ...
      <div className="hidden md:flex">
        <div className="text-[6vw] md:text-[40px] lg:text-[68px] 2xl:text-[100px] relative text-nowrap whitespace-nowrap leading-snug left-[-20px] font-suit md:font-semibold">
          <span className="absolute text-[5vw] left-[-6vw] top-[0.8vw] md:left-[-50px] md:top-[8px] md:text-4xl lg:left-[-78px] lg:top-[18px] lg:text-6xl 2xl:left-[-95px] 2xl:top-[36px] 2xl:text-7xl text-[#E1E8ED]">
            1
          </span>
          <span className="text-[#00B8FF]">if</span> (DEVELOP TOGETHER){' '}
          <span className="text-[#00B8FF]">{'{'}</span> <br />
          <span className="absolute text-[5vw] left-[-6vw] top-[9.5vw] md:left-[-54px] md:top-[63px] md:text-4xl lg:left-[-82px] lg:top-[110px] lg:text-6xl 2xl:left-[-100px] 2xl:top-[174px] 2xl:text-7xl text-[#E1E8ED]">
            2
          </span>
          ...
          <br />
          <span className="absolute text-[5vw] left-[-6vw] top-[17.3vw] md:left-[-54px] md:top-[118px] md:text-4xl lg:left-[-82px] lg:top-[204px] lg:text-6xl  2xl:left-[-100px] 2xl:top-[308px] 2xl:text-7xl text-[#E1E8ED]">
            3
          </span>
