...
export default function GoalsLayout() {
  return (
    <div className="flex flex-col w-[90%] py-6 md:py-20 md:w-[70%]">
      <motion.span
        initial={{
          x: -50,
          opacity: 0,
      ...
      <div className="flex md:justify-end">
        <div className="flex flex-col md:flex-row md:w-3/4 md:py-20 md:pt-32 md:space-x-8">
          ...
          >
            <span className="text-[6vw] pb-4 md:text-4xl md:pb-14">성장</span>
            <span className="text-[#657786] text-[3.8vw] md:text-base leading-[1.8]">
          ...
          <motion.div
            ...
            className="flex flex-col py-10 md:py-0"
          >
            <span className="text-[6vw] pb-4 md:text-4xl md:pb-14">열정</span>
            <span className="text-[#657786] text-[3.8vw] md:text-base leading-[1.8]">
          ...
          <motion.div
            ...
            className="flex flex-col py-10 md:py-0"
          >
            <span className="text-[6vw] pb-4 md:text-4xl md:pb-14">
              커뮤니케이션
            </span>
            <span className="text-[#657786] text-[3.8vw] md:text-base leading-[1.8]">
